...
tape( 'the function returns an iterator for generating pseudorandom numbers from a standard normal distribution using the Box-Muller transform', function test( t ) {
	var rand;
	var it;
	var i;
